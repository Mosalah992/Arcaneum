...
-- AR-II-001 — Ahzirr Traajijazeri
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (12, 'AR-II-001', 'Ahzirr Traajijazeri', 'Anonymous', 'Faction Books',
...
We want our life and our home back as it was twenty years ago, but if that is not realistic, then we will accept a different simple, pragmatic goal. Revenge. With a smile.', 0, '');

-- AR-II-002 — Brothers of Darkness  [SEALED]
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (13, 'AR-II-002', 'Brothers of Darkness', 'Pellarne Assi', 'Faction Books',
...
Although helping the Guild perform their petty crimes brands me as a criminal, I feel that it’s a burden worth bearing. The mystery of the Thieves Guild’s fall from power needs to be solved once and for all as a matter of record and as a footnote to Skyrim’s history.', 0, '');

-- AR-II-004 — A Kiss, Sweet Mother  [SEALED]
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (15, 'AR-II-004', 'A Kiss, Sweet Mother', 'Anonymous', 'Faction Books',
...
Then wait, child, for the Dread Father Sithis rewards the patient. You will be visited by a representative of the Dark Brotherhood. So begins a contract bound in blood.', 1, '');

-- AR-II-005 — The Nightingales
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (16, 'AR-II-005', 'The Nightingales', 'Gallus Desidenius', 'Faction Books',
   '## Volume I: Who We Are
...
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (17, 'AR-II-006', 'Nords Arise!', 'Anonymous', 'Faction Books',
...
-- AR-II-007 — Pension of the Ancestor Moth
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (18, 'AR-II-007', 'Pension of the Ancestor Moth', 'Anonymous', 'Faction Books',
...
As a novitiate, you will learn the teachings of Gudrun. You will learn the way of the peaceful fist. You will learn to serve the blind monks. You will learn to provide. In time, you may attain the peace and insight of the Ancestor Moths.', 0, '');

-- AR-II-008 — Shadowmarks
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (19, 'AR-II-008', 'Shadowmarks', 'Delvin Mallory', 'Faction Books',
...
The opposite of the Loot Shadowmark. Pass on this place, there’s nothing inside.', 0, '');

-- AR-II-009 — Fire and Darkness
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (20, 'AR-II-009', 'Fire and Darkness', 'Anonymous', 'Faction Books',
...
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (21, 'AR-II-010', 'Great Harbingers', 'Anonymous', 'Faction Books',
...
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
  (22, 'AR-II-011', 'Ice and Chitin', 'Anonymous', 'Faction Books',
...
INSERT INTO citations (from_tome, cites_call_number) VALUES (16, 'AR-I-007');
INSERT INTO citations (from_tome, cites_call_number) VALUES (17, 'AR-IV-023');
INSERT INTO citations (from_tome, cites_call_number) VALUES (18, 'AR-X-002');
