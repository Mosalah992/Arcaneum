-- Migration 0006 — Instruction & Research.
--
...
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
 ...
 threat to them and gradually ceased their attacks. Though
 more than capable of fending them off (a combination of fire
 and turning spells are generally sufficient), I admit that I
 tired of having to be ever vigilant in their presence.

I’ll never know whether there was some sort of agreement
 communicated among them, for the only utterances they make
 seem to be in that heathen tongue that I can’t even
 pronounce, much less transcribe. In time, I learned more of
 their intentions towards me from their general movements and
 tones rather than specific words. Hostility in any creature
 is easily read, but in these most peculiar of the living
 dead, with such variations in gait and speed, what amounts
 to a hostile charge in one may simply be casual movement in
 another. The eyes seem to be key to their intent, and I will
 confess to more than one dream haunted by the glowing
 pinpoints in the darkness.

I had always wondered why the ancient priests of the dragon
 cult insisted that their followers be buried with them. It
 seems the height of pagan vanity to drag your conscripts to
 their death along with you, but as I integrated into their
 presence, I began to observe the reasons. Every day, a
 different set of draugr would awaken, shamble their way to
 the sarcophagus of their priest, and prostrate themselves
 before it. Several hours of this, followed by a meticulous
 cleaning of the area. It would appear that the adherents of
 the dragon priest continue their worship of him in death,
 which would also explain the ferocity with which they defend
 his chambers.

It took several weeks before I felt comfortable approaching
 the dragon priest’s resting place, myself. Inch by inch,
 until the snarling draugrs around me seemed to tire of
 fending off my timid presence. I was able to set some simple
 scrying spells around the tomb, that I might get a sense of
 what magical energies resided there. When the next group of
 draugr came to pay homage to the priest, I noted a sort of
 transferal happening. A distinct flow of life force between
 the adherents and the master.

It was here that I finally understood the dragon cult’s
 notion of resurrection. The second eternal life was only
 promised to those who ascended to the priesthood, but the
 lesser functionaries contributed their life force to
 sustaining them for eternity. I don’t know what sort of
 eternal wellspring they draw from, but it’s clear that each
 draugr carries only the barest whisper of life in it, and
 rekindles it nightly while resting in its niche. I now
 believe that the grotesque forms that we see in the barrows
 were, in fact, buried fully as men and women, and only over
 the thousands of years that have passed withered into the
 wretched things we know. If we had visited a barrow directly
 after its construction, we might not have even known any of
 its inhabitants were dead!

These discoveries and extrapolations excite me, and my mind
 aches to return to the barrows. I have only paused here at
...
The very word conjurs nightmare images of shadowed skies,
 hideous roaring, and endless fire. Indeed, the dragons were
 terrifying beasts that were once as numerous as they were
 deadly.

But what most Nords don’t realize is that the dragons were
 in fact not simple, mindless beasts. Indeed, they were a
 thriving, intelligent culture, one bent on the elimination
 or enslavement of any non-dragon civilization in the entire
 world.

It therefore stands to reason that the dragons would require
 a way to communicate with one another. That they would need
 to speak. And through much research, scholars have
 determined that this is exactly what the dragons did. For
 the mighty roars of the beasts, even when those roars
 contained fire, or ice, or some other deadly magic, were
 actually much more - they were words. Words in an ancient,
 though decipherable, tongue.

Nonsense, you say? Sheer folly on the part of some overeager
 academics? I thought precisely the same thing. But then I
 started hearing rumors. The odd snippet of a conversation
 from some brave explorer or gold-coveting crypt diver. An
 always, always, it was the same word repeated:

Wall.

So I listened more. I began to arrange the pieces of the
 puzzle, and slowly unravel the mystery.

Spread throughout Skyrim, in ancient dungeons, burial
 grounds, and other secluded places, there are walls. Black,
 ominous walls on which is written a script so old, so
 unknown, none who had encountered it could even begin its
 translation.

In my heart, I came to know the truth: this was proof of the
 ancient dragon language! For what else could it possibly be?
 It only made sense that these walls were constructed by the
 ancient Nords, Nords who had lived in the time of the
 dragons, and out of fear or respect, had somehow learned and
 used the language of the ancient beasts.

But at that point, all I had was my own gut instinct. What I
 needed was proof. Thus began the adventure of my life. One
 spanning 17 months and the deaths of three courageous guides
 and two sellsword protectors. But I choose not to dwell on
 those grim details, for the end result was so glorious, it
 made any hardship worth it.

In my travels, I found many of the ancient walls, and every
 suspicision proved true.

It did in fact appear as if the ancient Nords had copied the
 language of the dragons of old, for the characters of that
 language very much resemble claw marks, or scratches. One
 can almost envision a majestic dragon using his great, sharp
 talons to carve the symbols into the stone itself. And a
 human witness - possibly even a thrall or servant -
 learning, observering, so that he too could use the language
 for his own ends.

For as I observed the walls I found, I noticed something
 peculiar about some of the words. It was as if they pulsed
 with a kind of power, an unknown energy that, if unlocked,
 might be harnessed by the reader. That sounds like nonsense,
 I know, but if you had stood by these walls - seen their
 blackness, felt their power - you would understand that of
 which I speak.

Thankfully, although entranced, I was able to retain enough
 sense to actual transcribe the characters I saw. And, in
 doing so, I began to see patterns in the language - patterns
 that allowed me to decipher what it was I was reading.

For example, I transcribed the following passage:

Assigning those scratchings to actual Tamrielic langauge
 characters, I further translated what I saw into this:

Het nok Yngnavar Gaaf-Kodaav, wo drey Yah moron au Frod do
 Krosis, nuz sinon siiv dinok ahrk dukaan.

Which translates into the Tamrielic as follows:

Here lies Yngnavar Ghost-Bear, who did Seek glory on the
 Battlefield of Sorrows, but instead found death and
 dishonor.

Then, in another crypt, I encountered a wall with this
 transcription:

Which translates into:

Het nok kopraan do Iglif Iiz-Sos, wo grind ok oblaan ni ko
 morokei vukein, nuz ahst munax haalvut do liiv krasaar.

Which ultimately translates into the Tamrielic as:

Here lies the body of Iglif Ice-Blood, who met his end not
 in glorious combat, but at the cruel touch of the withering
 sickness.

And there you see the pattern. The repeated words “Here
 lies” - which could only mean one thing: those walls marked
 actual ancient Nord burial grounds.

You can imagine my nearly uncontainable excitement. It all
 started to make sense. The anicent Nords used the dragon
 langauge for these walls for very specific reasons. One of
 them was obviously to mark the grave of some important
 figure. But what else? Were they all graves, or did they
 serve other purposes as well?

I set off to find out, and was well rewarded for my efforts.
...
Het mah tahrodiis tafiir Skorji Lun-Sinak, wen klov govey
 naal rinik hahkun rok togaat wah gahrot.

Which in Tamrielic translates into this:

Here fell the treacherous thief Skorji Leech-Fingers, whose
 head was removed by the very axe he was attempting to steal.

So here we see a wall that marks the spot where some
 significant ancient Nord died.

This passage:

Translates into this:

Qethsegol vahrukiv daanik Fahliil kiir do Gravuun Frod, wo
 bovul ko Maar nol kinzon zahkrii do kruziik hokoron.

Which in Tamrielic translates into this:

This stone commemorates the doomed elf children of the
 Autumn Field, who fled in Terror from the sharp swords of
 the ancient enemy.

This wall seems to commemorate some ancient, long-forgotten
 event in Tamrielic history. Whether that event occurred on
 or near the place where the wall was erected, we will
 probably never know.
...
Aesa wahlaan qethsegol briinahii vahrukt, Thohild fin Toor,
 wen smoliin ag frin ol Sahqo Heim.

Which in Tamrielic translates into this:

Aesa raised this stone for her sister, Thohild the Inferno,
 whose passion burned hot as the Red Forge.

This wall (and I encountered quite a few like this) was
 obviously commissioned or built by a specific person, to
 honor someone important to them. What was the significance
 of the location? Was it important to the person who died? Or
 is it the actual location of that person’s death? Again,
 those answers are probably lost to time, and will never be
 know.

And so you see, the ancient dragon language is, indeed, myth
 no more. It existed. But better yet, it still exists, and
 probably will until the end of time, thanks to the ancient
 Nords and their construction of these many “word walls.”

But don’t take my word for it. For the walls are there for
 the discovering, in Skyrim’s dangerous, secret places. They
 serve as a bridge between the realm of the ancient Nords,
 and our own. The dragons may never return to our world, but
...
Let me begin by correcting a common misconception. The
 proper term to use when referencing the ancient lost race of
 Tamriel is “Dwemer.” It is a word whose meaning is roughly
 translated to “people of the deep” in the common tongue, and
 whose use has been widely replaced by the more ubiquitous
 nomenclature, “dwarves.” I would like stated that I use the
 name “dwarves” in lieu of the more accurate term in these
 books out of sympathy for my readership, whom I can safely
 assume does not have the breadth of scholarship that 200
 years of study has given me.

With that small point finished, let us begin our discussion
 on the dwarves by focusing on the indisputable artifacts
 they have left behind: their architectural and cultural
 designs. Unlike the more controversial areas of dwarven
 scholarship, the construction of dwarven cities and relics
 are well-founded due to the plethora of samples taken from
 the ruins these peoples have left behind. My own home city,
 Markarth, was originally one such ruin, and I can state from
 first-hand experience that all dwarven designs share a set
 of common principles that we can use to determine true
 artifacts from fakes and delineate patterns and
 methodologies that were important to their craftsmen.

First of all, we can say for certain that dwarven artisans
 favored stone, at least as far as their buildings were
 concerned. This is no surprise. With notable exceptions, the
 vast majority of dwarven architecture is found underground
 or carved out of mountains. It is possible, although only
 theoretically, that the dwarves first mastered masonry as a
 race quite early, and later examples of metalwork were added
 on to much earlier stone designs as the dwarves began to
 master more complex tools. Regardless, the foundation of all
 known dwarven ruins is built on stonework, and the structure
 of dwarven stonework is sharp, angular, and intensely
 mathematical in nature.

By a simple count, there are hundreds if not thousands of
 samples of dwarven buildings made of precise square shapes,
 and far fewer examples of discretely rounded or curved
 stonework, leading us to believe that early dwarves favored
 trusted, well-calculated designs based on angled lines
 rather than riskier, more imprecise calculations based on
 arcs and curves. This comparatively simple tradition of
 stonecutting has nevertheless resulted in buildings that are
 as structurally sound today as they were thousands of years
 ago, making the works of our most skilled masons today seem
 like child’s play in comparison.

Metalwork as far as we know is the primary method used to
 make almost all dwarven crafts. We cannot, however, discount
 more easily destructible materials such as clay, paper, and
 glass from outside the scope of dwarven craftsmanship, but
 given the tendency of dwarven design to favor the
 long-lasting over the fragile, we can safely assume that at
 the very least metal was a heavy preference. And the metal
 used in all so-far-discovered dwarven relics is entirely
 unique to their culture.

No other race has replicated whatever process was used to
 create dwarven metal. Although it can be easily mistaken for
 bronze – and in fact many forgers of dwarven materials use
 bronze to create their fake replicas – it is most definitely
 a distinct type of metal of its own. I have personally seen
 metallurgists attempt to combine several different types of
 steel and common and rare ores in order to imitate dwarven
 metal’s exclusive properties, but the only method that has
 been successful is to melt down existing dwarven metallic
 scraps and start over from there.

## Volume II: Weapons, Armor, and Machines

In our previous discussion on the dwarves (or “Dwemer” in
 the more correct, scholarly terminology), we looked into the
 properties of dwarven architecture and metallic crafts. In
 this continuing discussion of Tamriel’s Lost Race, we shall
 examine the ways in which dwarves waged war and kept out
 trespassers. Unlike many other cultures still existing
 today, the dwarves built and relied on increasingly
 complicated machines for a wide variety of martial tasks,
 and weapons and armor created solely for the purpose of
 being wielded by dwarven warriors show remarkably fewer
 points of progress beyond the basic designs.

Let us begin by analyzing those basic weapons and armors.
 Anyone who has held a dwarven axe or worn a dwarven helmet
 can testify as to the ancient, ever-lasting quality of
 dwarven craftsmanship. Weapons do not deviate too greatly
 from their base function. Dwarven swords pierce through
 light armors with incredible effectiveness, owing primarily
 to the remarkable sharpness of tempered dwarven metal, and
 owing to a far lesser extent to its simple, double-edged
 design.

Compare and contrast a sharp, angular dwarven dagger to a
 curved elven blade, and it becomes a small logical leap to
 say that dwarven weaponsmiths relied almost exclusively on
 creating quality materials first, and merely allowed the
 form of those materials to flow from the method that weapon
 was intended to kill people.

As a culture that built almost exclusively underground, it’s
 no surprise that dwarven armors are built to withstand
 incredibly heavy blows. Again, the fact that they are also
 resistant to being pierced by arrows or small blades is more
 of a testament to superior dwarven metallurgy over superior
 dwarven armorsmithing, but it would be erroneous to thus
 conclude that dwarven smiths did not take the manufacture of
 their weapons and armor very seriously. Every piece of war
 crafts I have examined show a remarkable amount of
 unnecessary detailing and personalization that is just as
 evident today among the most ardent blacksmiths.

A dwarven smith probably came from a long tradition that
 distinguished itself in way that, say, the grip of a mace
 would feel, or the design of the head of individual arrows.
 Although, due to the paltry lack of any cultural artifacts
 outside the weapons and armors themselves, this is only mere
 speculation.

The last, but probably most important discussion in this
 volume, pertains to the existence of dwarven machinery.
 Dwarves created and manufactured on a very broad scale
 thousands of mechanical apparatuses of varying complexity.
 The most simple of which is the standard “arachnid” design
 used to ward off trespassers. We are so far uncertain as to
 how the dwarves were able to bring to life these remarkably
 intelligent machines, but I have witnessed one stalk a
 highly trained thief for several hours, only to ambush him
 as he was dealing with a lock to some room or treasure trove
 – I admit to have forgotten the details past the point at
 which it began spouting lightning at him.

Dwarven military machines also range from the human-sized
 “Sphere” warrior, which patrols the interiors of the ruins
 as a harmless ball only to emerge from it as a fully armed
 and armored automaton fighter, to the justly feared
 “Centurion” whose height ranges from twice to several
 hundred times human size depending on which reports you
 believe.

## Volume III: Culture and History

In this final volume on our discussion on the dwarves
 (again, see the term “Dwemer” for references using the more
 scholastic name), we will attempt an examination into the
 distinct culture and history of Tamriel’s Lost Race. We
 must, however, begin such a discussion with a warning.
 Despite what certain academic circles would like people to
 believe, there is so far no evidence that verifies any claim
 as to the dwarves’ particular customs, morals, myths,
 legends, laws, systems of governance, or involvement in
 major historical events outside of those few examples that
 remain indisputable.

For instance, while we can say with absolute certainty that
 the disappearance of the entire dwarven race happened very
 suddenly, only the laziest of junior scholars would say that
 this event happened in the same day or even the same hour.
 There is simply no proof to dispute the theory that perhaps
 the dwarves disappeared from Tamriel gradually over the
 course of several years or indeed several decades.

There is also nothing that disproves the source of this
 disappearance as being attributable to mass deaths, plagues,
 magical contamination, experiments into the nature of
 Aetherius gone wrong, or even race-wide teleportation into
 one of the planes of Oblivion. There is simply too little
 that the dwarves left behind that points to the nature of
 their great vanishing act, and this same frustration applies
 to all aspects of their social structure and history.

What we know then can only be inferred by the writings of
 the other races which made contact with the dwarves before
 they left Tamriel. The dark elves ("Dunmer") for example
 teach that their great prophet Nerevar helped unite the
 dwarves and the elves in Morrowind against occupying Nord
 armies from Skyrim in the First Era, but Nord and Orc
 writings also indicate that the dwarves were also allied
 with them at various points and in various legendary battles
 of theirs.

Unfortunately, none of these legends and folk lore make an
 effort to describe the dwarves in great detail, only that
 they were a secretive people and that an alliance with them
 was unusual enough to warrant crafting a story around. And
 past the First Era, no race makes note of encountering any
 living dwarves at all. This is further confounded by the
 fact that so many of the dark elven writings on their
 relationship with the dwarves were lost during the tragic
 eruptions of Vvardenfell during the Oblivion Crisis nearly
 200 years ago. What secrets they could have revealed about
 the Lost Race are now buried behind layers of molten earth
 along with so many unfortunate dark elven people.

Thus, we conclude our discussion on the dwarves on a somber
 note. As with all scholarly endeavors, we are left with more
 questions than we have answers, and the proof we so
 desperately search for is so often out of reach, denied even
 to the most fervent effort.

The mysteries the dwarves have left us with could easily
 warrant another century or so worth of personal examination
 from me, and quite possibly even several millennia of
 excavation of even one dwarven ruin would be insufficient to
 paint a complete picture on them. But what we can see from
...
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
 ...
 without capability. This text will cover only the basics of
 Enchanting. It is but a primer for students of the College
 of Winterhold.

Before a weapon or bit of armor can be enchanted, the wizard
 must first learn the enchantment. This is a personal task.
 Enchantments cannot easily be passed from one mage to
 another. They must be understood at a primal level that can
 only be achieved by destroying an enchanted item and
 absorbing its nature.

The Arcane Enchanter is specifically designed for this task.
 Merely place an enchanted item in the device and will it to
 relent. The magic will flow into the mage, imbuing him with
 the knowledge of how the enchantment is formed. The utter
 destruction of the enchanted item is the unavoidable
 consequence of this process.

Items that already have enchantments cannot be enchanted
 further, so choose carefully when you enchant a blade or
 helmet. Before beginning an enchantment, make sure you have
 a filled soul gem. The enchantment will use this soul as a
 source of power. Place the item and the soul gem on the
 Arcane Echanter. Concentrate on the enchantment. The device
 will meld the two together, enchanting your weapon or armor.

Armor enchantments are permanent and do not need to be
 charged or powered. The reasons for this are not known. Some
 in the College have postulated that the wearer contributes
 small amounts of his own energy to keep the armor enchanted.
 Others say it is just the will of Magnus that it works that
 way. Regardless of the reason, enchanted armor and clothing
 never wear out.

Weapon enchantments are a different story. They slowly use
 up the soul energy in them until they are depleted. The
 enchantment remains, but a filled soul gem must be used to
 recharge the weapon. Perhaps it is the destructive nature of
 the weapon enchantment that makes it deplete. One intriguing
 theory is that the soul leaks out a little at a time into
 the victims that the weapon harms. As a novice enchanter,
 the reason is immaterial.

At first you will find that your enchantments require a lot
...
INSERT INTO tomes (id, call_number, title, author, school, body, restricted, volume) VALUES
 ...
 rumored to illiterate, and given that these notes are
 obviously written by an assistant, that rumor is likely
 true. I have made no attempt to correct the texts themselves
 as they may have historical value.

Without further ado, the ramblings of Thorbald:

This ain’t no book for how to be a grayt smith. So if you’re
 reeding this, stop. It’s just me own notes cawse I’m getting
 old and cranky and don’t rember stuff. These be me own
 methods for makin things.

Iron armor and weapons. Lots of Iron ingots and some leather
 strips.

Steel armor and weapons. Lots of Steel ingots, a little
 iron, and some leather strips. Cept for Steel Plate. It
 needs some Corundum too.

Leather armor and weapons. Who’d be stupid enuf to make
 leather weapons? Leather armor needs leather. Big peeces and
 little peeces. Just like Hide armor. And studded armor.
 Scaled armor too. Well, that needs some steel also. And
 Curundum. Can’t make Scaled armor without Corundum. That
 would be dum.

Dwarfen armor and weapons. Dwarfen scrap metal, some iron,
 and some leather strips. I’m gonna stop sayin leather, cawse
 it’s always used. Are you writin what I jus said? You idiot!
 Jus do it, don’t rite it. (Thorbald is old and fat)

Elven armor and weapons. Elves and dwarfs didn’t get along.
 Bet you didn’t know that. Elven stuff needs Moonstone and a
 little bit of iron. Except for that Gilded stuff. Gotta add
 Quicksilver if you wanna make Gilded Elven armor.

Orcish armor and weapons. Use Orichalcum and a bit of iron.
 (Thorbald doesn’t like Orcs)

Ebony armor and weapons. Takes only Ebony. No iron. Not even
 a little. You’ll want to, but don’t.

Glass armor and weapon. Need Malachite and sum Moonstone.
 Nasty stuff, workin’ with Malachite.

Daedric armor and weapons. Hah! Like I’d rite that down. (He
 uses daydra hearts. I don’t know whare he gets ’em)

That’s all. You can stop writin now. I said stop!

Postscript - The last page had a large streak of ink an a
 few splatters of blood. It would be a fair conclusion that
 Thorbald beat his assistant. We have no way of know if
...
The Dwarves have been extinct for many an age, and perhaps
 for the best. To see men and women the size of large
 children, all with beards, would be a most disturbing sight.
 Still, whatever wrath the Dwarves brought from the gods that
 consumed an entire civilization surely must have been an
 awe-inspiring thing to witness.

The remnants of their civilization lie buried in the hearts
 of mountains, and scholars and thieves the world over
 descend on the skeletal remains of dwarven cities like
 vultures, to scrape clean the bones of the past, old
 knowledge waiting to be exhumed and treasures to be
 discovered. But many men lay murdered in those halls of the
 damned, because those dwarven ruins do not release their
 treasures without a fight.

My kin would tell the stories long ago, when I was just a
 child, about how adept the Dwarves were at building
 machines. They would say that before our time, dwarves
 harnessed the power of the earth, and wielded fire and
 hammers to reshape steel and bronze with a mechanical
 brilliance that breathed life into these now ancient
 constructs of metal and magic. In the dark halls and
 chambers amid the ceasless droning of grinding gears and
 venting steam, they lie in wait to confound or destroy
 would-be plunderers of the dwarven sanctums, as the grim
 watchmen of the last vestiges of culture from a dead race.

I descended into the humid darkness of Mzulft. The slow hiss
 of steam, creaking of metal and the rattle of old gears
 powering an empty city would unnerve most men. I could hear
 things in the darkness, skittering across the floor just out
 of sight and as I stepped over the bodies of plunderers or
 scholars who had not made it far, I knew it was not rats
 wandering these halls.

Small mechanical spiders set upon me with rapid movements,
 and machines sprouted from the walls and uncurled from
 spheres into contraptions that rolled on top of gears for
 legs and crossbows for arms. I could not help but marvel at
 these single purpose machines built for the murder of men.
 My sword and my shield are my strength and I am undeterred
 by such things because I had heard of greater things that
 roam these depths, and indeed something else in these
 chambers stirred, and it echoed with massive weight. As it
 lumbered closer, its feet struck the ground as if walking on
 massive pistons and as it loomed out of darkness, I could
 see it clear for the first time, axe for one hand, hammer
 for the other, as tall as five men, made of dull bronze with
 a face molded in the image of its masters. A Steam
 Centurion. The stories were true, these were the guardians
 of the greatest dwarven treasures.

We fought, and the dwarves must truly be extinct because our
 battle was surely booming enough to wake the dead. It came
 at me with hammer and axe, inhuman strength and great
 fortitude, and a purpose of nothing but murder. I dodged as
 it crushed the stone around me with futile strikes and I
 thrust and slashed at it with my blade and took every
 opening afforded as we shook the halls with violence. I
 refuse to be undone by a machine.

Where the average man would be long dead, I stood over the
 husk of this dead automaton, its steam escaping like a final
 gasp. I could have taken the dwarven artifacts and metal but
 left them there for others, for I would not hex my journey
 with the possessions of dead men and maybe that is where
 countless others go wrong.

I will continue to my journey across the lands, And perhaps
 one day Herebane will meet a worthy challenge, for I have
 yet to see what would make me tremble.

## Hagravens

5 Sun’s Dawn

I have heard a tale most bizarre- a beautiful young woman
 cast out of town by the thrown stones of accusers for giving
 in to the dark arts. They say she fled into the Reach and
 never reappeared, and justly so because they say the devilry
 of her magic had grown stronger with each new day. Shortly
 after, a witch of half woman and half bird had been sighted
 deep in the mountains, and as the sightings increased the
 young women began to disappear.

This tale has brought me to the Reach, where this witch they
 call a Hagraven makes it home. With sword and shield at the
 ready, for I must see this creature and I must slay it.

24 Sun’s Dawn

The stomach of an average man would turn at the cruelty set
 before me- I first saw the thatch and bone, the human
 skulls, the dead goat heads mounted on pikes, filthy animal
 pelts, loose entrails, and feathers matted in blood. I had
 heard that Forsworn revere and protect these Hagravens, and
 all around were their small, crude trinkets and alters to
 these witches on which sat dull, empty soul gems. What vile
 creature would live where all things are dead?

Deeper into the lair, I heard it first- an unsteady
 shuffling, followed by a heaving, unforgettable stench. I
 thrust the torch in front of me and waited for my eyes to
 adjust to the tunnel of darkness ahead of me. I saw the
 silhouette of what I thought to be a frail woman on an
 awkward gait, but the light of the torch revealed something
 else. This Hagraven was horrifying, almost human but more an
 abomination of woman and creature fused together, nothing
 more than a husk of humanity surrendered in exchange for
 possession of the powers of dark magic. This magic corrupted
 her greatly, and her dull, glass eyes stared with hate from
 the visage of an old crone sat atop the body of a contorted,
 misshapen human body adorned with black feathers. It
 bristled as it let out a piercing scream, and as a vivid red
 light began to form in the palm of its talons, it was all I
 could do to raise my shield in defense of magic most foul. I
 fought through devilry that seemed to snatch life from me,
 and the thought that this thing was once a woman seemed to
 play on my nerves.

Most men would have crumbled, but I do not bend. The
 Hagraven is a most repulsive creature, and deserving of its
 fate and its claws that are my trophy will tell the story of
 Herebanes triumph. I have naught but to continue my travels
 and my conquests, for I have yet to see what would make me
 tremble.
...
When winters chill descended upon me as I traveled further
 north through the frozen plains and mountains, I settled in
 at the inn at Dawnstar for a moment of respite and a warm
 meal. Another traveler there told me to be cautious, that
 there are creatures who settle into the powder white of the
 snow with nary a clue to the careless, until it is too late.
 He went on and on, with wild gestures and fantastic tales of
 entire merchant expeditions being killed by the beasts. His
 stories frightened the other inn patrons, but I will not be
 turned by a coward’s tale, I will see these for my own eyes,
 for those icy caves and snow capped peaks of the north are
 exactly the type of places that call to an adventurer like
 me. It did not take me long to find what I sought.

These Ice Wraiths are lucid, serpentine creatures of magic,
 as if conjured from the frozen tundra and glaciers of Skyrim
 itself. At one with an environment that makes them nearly
 invisible, these ethereal apparitions are the death of many
 Nords, if not by their sudden, unholy strike that casts
 their entire body through their target, then by the malady
 of Witbane, a curse of infection that dulls the intellect
 and makes the target even more the victim.

As deadly as they are, Ice Wraiths are simple minded in
 their determination, and combat is a straight forward affair
 and brute force and a sharp blade are enough to fell these
 savage creatures. Only the heartiest of men would hope to
 survive just one of these beasts, but I have slain two with
 general ease.

It’s good that I’ve found I can make decent coin selling the
